...
namespace Subjectify.Controllers
{
    public class SubjectController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FacultyId,Id")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("FacultyId,Id")] Subject subject)
        {
            if (id != subject.Id)
            {
                return NotFound();
